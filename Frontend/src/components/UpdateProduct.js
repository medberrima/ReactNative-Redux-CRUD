...
import {View, StyleSheet, TouchableWithoutFeedback, Keyboard, TextInput, Text, ScrollView, SafeAreaView} from 'react-native';
          ...
          <View style={globalStyles.container}>
            <Formik
              initialValues={ {
                ...
                "rating": route.params.rating.toString(),
              }}
              validationSchema={ReviewSchema}
              onSubmit={(values, actions) => {
                store.dispatch(updateProduct(values));
